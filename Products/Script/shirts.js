...
fetch(`https://gentshub-y1jk.onrender.com/shirts`)
.then((res) => {
  return res.json()
})
.then((data)=>{
...
fetch(`https://gentshub-y1jk.onrender.com/shirts?_limit=12&page=1`)
.then((res) => {
 ...
 console.log(paginationButtons)
  for(let btn of paginationButtons){
    btn.addEventListener("click",(e)=>{
      ...
      console.log(btn)
      fetch(`https://gentshub-y1jk.onrender.com/shirts?_limit=12&_page=${dataId}`)
      .then((res) => {
         return res.json()
      })
      .then((data)=>{
